...
export default function MessageInput({
  ...
  return (
    <div className="border-t border-gray-200 bg-white shadow-lg">
      {error && (
        <div className="px-3 sm:px-4 py-2 sm:py-3 bg-red-50 border-b border-red-200">
          ...
          >
            ...
            {loading ? (
              <>
                ...
                <span className="relative text-sm sm:text-base hidden sm:inline">Sending...</span>
              </>
            ) : (
              <>
                <svg className="w-4 h-4 sm:w-5 sm:h-5 transform group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-200 relative" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                </svg>
                <span className="relative text-sm sm:text-base hidden sm:inline">Send</span>
              </>
            )}
          </button>
        </div>
